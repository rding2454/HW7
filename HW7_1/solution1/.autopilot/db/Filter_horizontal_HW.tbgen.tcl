set moduleName Filter_horizontal_HW
...
set C_modelName {Filter_horizontal_HW}
set C_modelType { void 0 }
set C_modelArgList {
	{ Input_r int 8 regular {array 5184000 { 1 1 } 3 1 }  }
	{ Output_r int 8 regular {array 518400 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ Output_r_address0 sc_out sc_lv 19 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Output_r_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "Output_r", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Filter_HW_mac_mulcud_U0", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Filter_HW_mac_mulcud_U1", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "511928", "Max" : "511928"}
	, {"Name" : "Interval", "Min" : "511928", "Max" : "511928"}
]}
...
set Spec2ImplPortList { 
	...
	Output_r { ap_memory {  { Output_r_address0 mem_address 1 19 }  { Output_r_ce0 mem_ce 1 1 }  { Output_r_we0 mem_we 1 1 }  { Output_r_d0 mem_din 1 8 } } }
}
