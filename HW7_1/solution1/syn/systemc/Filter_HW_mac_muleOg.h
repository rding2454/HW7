...
#ifndef __Filter_HW_mac_muleOg__HH__
#define __Filter_HW_mac_muleOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter_HW_mac_muleOg) {
    ...
    SC_CTOR(Filter_HW_mac_muleOg):  simcore_mac_1_U ("simcore_mac_1_U") {
