...
#ifndef __Filter_HW_mac_mulcud__HH__
#define __Filter_HW_mac_mulcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter_HW_mac_mulcud) {
    ...
    SC_CTOR(Filter_HW_mac_mulcud):  simcore_mac_0_U ("simcore_mac_0_U") {
