...
#ifndef __Filter_HW_mac_mulfYi__HH__
#define __Filter_HW_mac_mulfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter_HW_mac_mulfYi) {
    ...
    SC_CTOR(Filter_HW_mac_mulfYi):  simcore_mac_2_U ("simcore_mac_2_U") {
